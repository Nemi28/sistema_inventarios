...
import { Store, TrendingUp, Download } from 'lucide-react';
...
export const TiendasInventarioPage = () => {
  ...
  const { data, isLoading, refetch } = useEquiposTiendas({
    page,
    limit: 20,
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Equipos en Tiendas</h1>
            <p className="text-gray-500 mt-1">
              {data?.paginacion.total || 0} equipos asignados a tiendas
            </p>
          </div>
        </div>
        {canExport && (
      ...
      <div className="flex-1">
        <SearchBar
          ...
          placeholder="Buscar por serial, inv. entel, tienda..."
          isLoading={false}
        />
      </div>
